...
export default function Dashboard() {
  ...
  const allNews = [
    {
      id: 1,
      title: "Amazon Rainforest Deforestation Reaches Record Low",
      description: "New conservation efforts show promising results.",
      date: "2 hours ago",
    ...
    },
    {
      ...
      description: "Revolutionary technology clears Pacific Ocean.",
      date: "5 hours ago",
      category: "Marine",
      image:
    ...
    {
      id: 3,
      title: "Wildfire Prevention AI System Deployed",
      description: "AI-powered early warning system prevents fires.",
      date: "1 day ago",
      category: "Technology",
      image:
        "https://images.unsplash.com/photo-1592422746858-450d8e3c9e8e?w=400&h=300&fit=crop",
    },
    {
      id: 4,
      title: "Sustainable Mining Practices Adopted Globally",
      description: "Mining companies commit to zero-emission by 2030.",
      date: "1 day ago",
      category: "Industry",
      image:
    ...
    {
      id: 5,
      title: "Coral Reef Restoration Shows 80% Success Rate",
      description: "Breakthrough in coral regeneration techniques.",
      date: "2 days ago",
      category: "Marine",
      image:
    ...
    },
    {
      ...
      description: "Community project exceeds restoration goals.",
      date: "3 days ago",
      category: "Conservation",
      image:
    ...
    {
      id: 7,
      title: "Wildlife Population Increases in Protected Areas",
      description: "Endangered species numbers grow significantly.",
      date: "3 days ago",
      category: "Wildlife",
      image:
    ...
    {
      id: 8,
      title: "Green Energy Powers Remote Mining Operations",
      description: "Solar and wind reduce carbon footprint.",
      date: "4 days ago",
      category: "Energy",
      image:
    ...
    <>
      ...
      <div className="flex min-h-screen text-white relative">
        ...
        <aside
          ...
          } border-r-2 rgb-border-animate bg-slate-900/30 backdrop-blur-xl p-6 flex flex-col transition-all duration-300 relative z-10`}
        >
          <button
          ...
          <div className="mb-12">
            {!sidebarCollapsed && (
              <h1 className="text-2xl font-bold rgb-text-animate">EARTHSIGHT</h1>
            )}
            {sidebarCollapsed && (
          ...
          <nav className="flex-1 space-y-2">
            {navItems.map((item) => (
              <button
                ...
                } px-4 py-3 rounded-xl transition-all duration-300 group icon-spin-hover card-click-effect ${
                  item.active
          ...
          <div className="pt-6 border-t border-slate-800/50">
            <button
              ...
              className={`w-full flex items-center ${
                sidebarCollapsed ? "justify-center" : "gap-3"
              } px-4 py-3 rounded-xl text-slate-400 hover:text-red-400 hover:bg-red-500/10 transition-all duration-300 group card-click-effect`}
            >
              <LogOut />
        ...
        <main className="flex-1 overflow-auto relative z-10">
          <header className="sticky top-0 z-10 border-b-2 rgb-border-animate bg-slate-950/80 backdrop-blur-xl">
            <div className="flex items-center justify-between p-6">
              <div>
                <h2 className="text-3xl font-bold text-white rgb-text-animate">
                  Dashboard
                </h2>
                ...
                <div className="rounded-xl border-2 rgb-border-animate bg-slate-900/50 backdrop-blur-sm overflow-hidden">
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        <h3 className="text-xl font-bold text-white rgb-text-animate">
                    ...
                    <CesiumMap
                      points={[
                        ...
                        },
                        {
                          ...
                          lat: 0.0,
                          lng: -160.0,
                          title: "Pacific Marine Life",
                          description: "Marine ecosystem monitoring active",
                          color: "#3b82f6",
                        },
                        {
                          id: 3,
                          lat: 36.7783,
                          lng: -119.4179,
                          title: "California Forest Fire",
                          description: "Active wildfire zone detected",
                          color: "#f97316",
                        },
                        {
                          id: 4,
                          ...
                          lng: 15.8277,
                          title: "Congo Mining",
                          description: "Mining operations ongoing",
                          color: "#eab308",
                        },
                        {
                          id: 5,
                          ...
                          description: "Coral reef restoration project",
                          color: "#06b6d4",
                        },
                        {
                          id: 6,
                          ...
                          description: "Forest fire monitoring active",
                          color: "#dc2626",
                        },
                      ]}
                    />
                ...
                <div className="rounded-xl border-2 rgb-border-animate bg-slate-900/50 backdrop-blur-sm overflow-hidden sticky top-24">
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div>
                        <h3 className="text-lg font-bold text-white rgb-text-animate">
                          Latest News
                        </h3>
                    ...
                    {newsCount < allNews.length && (
                      <div className="flex justify-center mt-4">
                        <button
                          onClick={() =>
                            setNewsCount((prev) =>
                              Math.min(prev + 4, allNews.length)
                            )
                          }
